...
def test_successful_character_list_return(client):
    ...
    print("\nRetorno da consulta de todos personagens:", response.json())
...
def test_success_id_existent_return(client):
    ...
    print("\nRetorno da consulta de personagem existente:", response.json())
...
def test_error_id_non_existent_return(client):
    ...
    print("\nRetorno da consulta de personagem nao existente:", response.json())
